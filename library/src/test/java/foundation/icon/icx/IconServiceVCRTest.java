...
public class IconServiceVCRTest {
    ...
    void testGetBlockByHeight() throws IOException {
        ...
        assertEquals("aa9b739597043e25e669dbc20eadbc17455b898540bf88018c7f065bdedb393a", Numeric.cleanHexPrefix(block.getBlockHash()));
    }
    ...
    void testSendIcxTransaction() throws IOException {
        ...
        Transaction transaction = TransactionBuilder.of(new BigInteger("3"))
                ...
                .timestamp(new BigInteger("5728125f88950", 16))
                .nonce(new BigInteger("1"))
                .build();

        SignedTransaction signedTransaction = new SignedTransaction(transaction, wallet);
        String hash = iconService.sendTransaction(signedTransaction).execute();
        assertEquals("0xe8b64151e2c63b859abbe237b8a16e0e75298c924b05c7c514bab2ea5062d9cc", hash);
    }
    ...
    void testSendToken() throws IOException {
        RpcObject params = new RpcObject.Builder()
                .put("_to", new RpcValue(Address.of("hx4873b94352c8c1f3b2f09aaeccea31ce9e90bd31").build()))
        ...
        SignedTransaction signedTransaction = new SignedTransaction(transaction, wallet);
        String hash = iconService.sendTransaction(signedTransaction).execute();
        assertEquals("0x6f5f41da743aeea002f3ed6606f6bac507893af01a3efcb425eb2cba26d83968", hash);
    }
    ...
    void testDeployScore() throws IOException {
        ...
        Transaction transaction = TransactionBuilder.of(new BigInteger("3"))
                ...
                .timestamp(new BigInteger("572817dbda710", 16))
                .nonce(new BigInteger("1"))
        ...
        SignedTransaction signedTransaction = new SignedTransaction(transaction, wallet);
        String hash = iconService.sendTransaction(signedTransaction).execute();
        assertEquals("0x7bf4554efee3ec36bdebd2f1c54876c899115477e003ce16406114d39b473069", hash);
    }
    ...
    void testSendMessage() throws IOException {
        ...
        Transaction transaction = TransactionBuilder.of(new BigInteger("3"))
                ...
                .to(toAddress)
                .stepLimit(new BigInteger("75000"))
                .timestamp(new BigInteger("5728182661c98", 16))
                .nonce(new BigInteger("1"))
                .message("Hello World")
                .build();
