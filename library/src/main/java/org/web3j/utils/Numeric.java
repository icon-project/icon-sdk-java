...
import org.web3j.utils.exceptions.MessageDecodingException;
import org.web3j.utils.exceptions.MessageEncodingException;
...
public final class Numeric {
    ...
    public static String cleanIcxAddressPrefix(String input) {
        if (containsIcxAddressPrefix(input)) {
    ...
    public static boolean containsIcxAddressPrefix(String input) {
        return input.length() > 1 && input.charAt(0) == 'h' && input.charAt(1) == 'x';
    }
